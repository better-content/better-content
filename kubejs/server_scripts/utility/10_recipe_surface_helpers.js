// Shared recipe-surface helpers for retained expert-pass rewrites.
...
global.bcFactoryCrafting = function (event, id, output, count, pattern, keys) {
    if (global.bcIsLargeFormatPattern(pattern)) return
