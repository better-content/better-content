...
|---|---:|---:|---|
| Seared | early molten handling | 12 | Smeltery, melter, heater, casting, drains, tanks, gauges |
| Scorched | high-heat foundry handling | 14 | Foundry, alloyer, scorched casting, ducts, tank/gauge, anvil |
| Andesite | Create kinetic workcells | 19 | Press/mixer/saw/drill/crafter, logistics, fluid basics, pistons, SU controls |
| Brass | precision automation | 16 | Arms, observers, smart logistics, displays, package/stock tools, diesel engines |
| Airtight | PNCR pressure/refining/assembly | 15 | Tubes, valves, refinery, thermo plant, fluid mixer, assembly, advanced compressor |
| Electrical | electricity and heat conversion | 16 | Batteries, motors, generator parts, relays, connectors, energisers, reactor input |
