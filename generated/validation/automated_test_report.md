...
Generated: 2026-07-04T23:56:06.880889387Z

Repo: `/home/dev/workspace`

Instance: `/tmp/btm-plank-quarantine-smoke`
...
| latest engine log is recent                                   | 0.1 minutes old      |
| engine reached dedicated server startup                       |                      |
| world became playable/servable                                |                      |
| spawn preparation budget                                      | 30144 ms <= 60000 ms |
| server tick-behind budget                                     | 0 warnings, max 0 ms |
| world save budget                                             | 1298 ms <= 10000 ms  |
| hard engine log failure scan                                  |                      |
| performance budget: engine and world performance log analysis | 523.97 ms <= 750 ms  |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
