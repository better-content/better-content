...
Generated: 2026-07-04T08:50:37.455491632Z

Repo: `/home/dev/workspace`

Instance: `/tmp/btm-dimension-worldgen/prepared/server`
...
| spawn preparation budget                                      | 43320 ms <= 60000 ms |
| server tick-behind budget                                     | 0 warnings, max 0 ms |
| world save budget                                             | 1637 ms <= 10000 ms  |
| hard engine log failure scan                                  |                      |
| performance budget: engine and world performance log analysis | 675.88 ms <= 750 ms  |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
