// Replaces village trades with Create Deco coin purchases. Coin rarities are never convertible.

var BC_COIN = {}
var BC_COIN_CATALOGUE = global.BC_COIN_TIERS || []
for (var coinIndex = 0; coinIndex < BC_COIN_CATALOGUE.length; coinIndex++) {
    BC_COIN[BC_COIN_CATALOGUE[coinIndex].id] = BC_COIN_CATALOGUE[coinIndex].item
}
    ...
    MoreJSEvents.villagerTrades(function (event) {
        ...
        // Toolsmith: recovery tools and workshop consumables.
         bcAddTrades(event, 'minecraft:toolsmith', [
            ...
            [5, 'iron', 8, 'tinkers_construct_affixes:forerune_seal', 1, 1, 24],
            [5, 'iron', 8, 'tinkers_construct_affixes:afterrune_seal', 1, 1, 24]
        ])
