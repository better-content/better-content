...
- `crafting_policy.md`: complete mod-role inventory, item-support rules, crafting-graph definition, exception families, audit findings, and open policy decisions.
