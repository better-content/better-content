...
// Canonical material forms used by the Realistic Ores processing generator.
...
global.BC_STARTER_DEPOSITS = [
    {
        id: 'coal_measures', displayName: 'Coal Measures', tag: 'kubejs:deposit_ore_blocks/coal_measures',
    ...
    {
        id: 'ironstone', displayName: 'Ironstone', tag: 'kubejs:deposit_ore_blocks/ironstone',
    ...
    {
        id: 'copper_sulfide', displayName: 'Copper Sulfide', tag: 'kubejs:deposit_ore_blocks/copper_sulfide',
    ...
    {
        id: 'tin', displayName: 'Tin Vein', tag: 'kubejs:deposit_ore_blocks/tin',
    ...
    {
        id: 'zinc', displayName: 'Zinc Vein', tag: 'kubejs:deposit_ore_blocks/zinc',
    ...
    {
        id: 'lead_zinc_vein', displayName: 'Lead-Zinc Vein', tag: 'kubejs:deposit_ore_blocks/lead_zinc_vein',
    ...
    {
        id: 'quartz_vein', displayName: 'Quartz Vein', tag: 'kubejs:deposit_ore_blocks/quartz_vein',
    ...
    {
        id: 'bauxite_laterite', displayName: 'Bauxite Laterite', tag: 'kubejs:deposit_ore_blocks/bauxite_laterite',
