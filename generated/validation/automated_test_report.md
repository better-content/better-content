...
Generated: 2026-07-08T00:45:47.693555618Z

Repo: `/home/dev/workspace`

Instance: `/tmp/btm-fullsuite-smoke`
...
| performance budget: runtime core tag regression validation          | 562.65 ms <= 1500 ms                    |
| latest engine log is recent                                         | 0.05 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 30841 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| world save budget                                                   | 1253 ms <= 10000 ms                     |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 502.8 ms <= 750 ms                      |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
