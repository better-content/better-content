...
| Quests | Generated graph plus live SNBT | Nine hand-authored chapters remain; PowerGrid replaces the Dynamo milestone with stable IDs | FTB Quests | One quest source | quests, criteria | static + Build 181 runtime gate |
| Quest code | 25 criteria and 38 predicates registered | Exact 12 live criteria and 31 live predicates | Better Content Quests | No dead registrations | custom runtime | custom test + Build 181 runtime gate |
