...
|---|---|---|
| Create Foundations | Andesite alloy, hand power, millstone, deployer, andesite casing, first SU, clean water, deposit preprocessing | `C1_CRUSHED` |
| Create Components | Andesite machine casing, press, plates, mixer, saw/drill, mechanical crafting, basin work | `C2_CRAFTER` / `C2_MIXER` |
...
- Re-authors core fluid/package logistics around `kubejs:andesite_machine_casing` and `kubejs:brass_machine_casing`.
