...
// Remaining redstone-bearing components consume primitive wire instead of raw dust.
ServerEvents.recipes(function (event) {
    var outputs = [
    ...
    bcMoreRedReplace(event, outputs, ['minecraft:redstone', '#forge:dusts/redstone'], BC_MORERED.wire)
})
