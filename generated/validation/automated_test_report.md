...
Generated: 2026-07-15T22:31:45.302348006Z

Repo: `/home/dev/workspace`

Instance: `/home/dev/.cache/bc/fresh-custom-mods-smoke`
...
| performance budget: runtime core tag regression validation          | 542.76 ms <= 1500 ms                    |
| latest engine log is recent                                         | 0.04 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 28916 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| world save budget                                                   | 1232 ms <= 10000 ms                     |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 527.57 ms <= 750 ms                     |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
