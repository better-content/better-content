...
// Controller casting shortcuts bypass the casing-visible metallurgy boundary.
ServerEvents.recipes(function (event) {
    event.remove({ output: 'tconstruct:smeltery_controller' })
    global.bcFactoryCrafting(event, 'kubejs:metallurgy/tconstruct/smeltery_controller', 'tconstruct:smeltery_controller', 1, [
        'BGB',
        'GCG',
        'BGB'
    ], {
    ...
    global.bcFactoryCrafting(event, 'kubejs:metallurgy/tconstruct/foundry_controller', 'tconstruct:foundry_controller', 1, [
        'BGB',
        'GCG',
        'BGB'
    ], {
