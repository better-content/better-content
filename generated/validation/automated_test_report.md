...
Generated: 2026-07-04T05:50:15.001412007Z

Repo: `/home/dev/workspace`

Instance: `/tmp/btm-dimension-worldgen/cycle-1/server`
...
| spawn preparation budget                                      | 37965 ms <= 60000 ms |
| server tick-behind budget                                     | 0 warnings, max 0 ms |
| world save budget                                             | 1227 ms <= 10000 ms  |
| hard engine log failure scan                                  |                      |
| performance budget: engine and world performance log analysis | 509.42 ms <= 750 ms  |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
