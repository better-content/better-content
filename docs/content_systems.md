...
Current Dimensional Fonts reliquary generation is structure-set driven rather than biome-modifier feature driven. The procedural site design embeds each raised altar into a copper-framed square junction court, uses packed-mud paths and relic/trophy dressing as the ancient interdimensional language, no longer registers or places grave-soil tiles, and rejects near-build-limit overworld anchors instead of spawning sky-shelf reliquaries.
