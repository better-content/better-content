...
Generated: 2026-07-06T08:14:10.831287754Z

Repo: `/home/dev/workspace`

Instance: `/tmp/btm-questbook-smoke`
...
| performance budget: runtime core tag regression validation          | 538.16 ms <= 1500 ms                    |
| latest engine log is recent                                         | 0.04 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 30083 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| world save budget                                                   | 1074 ms <= 10000 ms                     |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 501.37 ms <= 750 ms                     |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
