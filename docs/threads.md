...
- Development lasts 1.8 seconds: 600 ms of archive-sepia structure, 600 ms of card-unique pigment, then 600 ms in which the canonical aspect trace connects the composition. A click or Space during development completes it and is consumed before any doorway or facsimile control. Completion swaps to the untouched full runtime image.
